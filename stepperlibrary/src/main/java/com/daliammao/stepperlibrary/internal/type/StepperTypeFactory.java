...
public class StepperTypeFactory {
     ...
     * @param stepperTabViewPage stepper layout to use with this stepper type
     * @return a stepper type
     */
    public static AbstractStepperType createType(int stepType, StepperTabViewPage stepperTabViewPage) {
        switch (stepType) {
...
//                return new ProgressBarStepperType(stepperLayout);
            case AbstractStepperType.TABS:
                return new TabsStepperType(stepperTabViewPage);
            default:
